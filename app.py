...
marker = st.text_input("Marker name", value="BAT25", help="This is the marker passed to `msianalyzer run-marker`.")
...
manifest_file = st.file_uploader(
    ...
    type=["json"],
    help="This JSON describes the marker (primers, reference, etc.). `fastq_files` will be overwritten."
)
...
if run_button:
    ...
    if manifest_file is None:
        ...
        with st.spinner("Running MSIanalyzer... this may take a few minutes depending on input size."):
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                # 5) Expose all output files for download, preview images
